...
public class Statistics extends JFrame {
    ...
    public void issueVaccine(){
        try {
            conn con =  new conn();
            String sql = "select * from issue_vaccine";
    ...
    public void takeVaccine(){
        try {
            conn con = new conn();
            String sql = "select * from take_vaccine";
            PreparedStatement st = con.c.prepareStatement(sql);
            ResultSet rs = st.executeQuery();
    ...
    public Statistics(){
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(47, 79, 79), 2, true), "Issue-Vaccine-Details",
        ...
        l1.setFont(new Font("Optima", Font.BOLD, 18));
        ...
        table_1.setFont(new Font("Optima", Font.BOLD, 12));
        scrollPane_1.setViewportView(table_1);

        JPanel panel_1 = new JPanel();
        panel_1.setBorder(new TitledBorder(new LineBorder(new Color(0, 204, 153), 2, true), "Vaccinated-People-Details",
