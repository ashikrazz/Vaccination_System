...
public class Forgot extends JFrame implements ActionListener{
	...
	l1.setFont(new Font("Optima", Font.BOLD, 13));
	l1.setBounds(109, 83, 87, 29);
	contentPane.add(l1);

	JLabel l2 = new JLabel("Name");
	l2.setFont(new Font("Optima", Font.BOLD, 13));
	l2.setBounds(109, 122, 75, 21);
	contentPane.add(l2);

	JLabel l3 = new JLabel("Your Security Question");
	l3.setFont(new Font("Optima", Font.BOLD, 13));
	l3.setBounds(109, 154, 156, 27);
	contentPane.add(l3);

	JLabel l4 = new JLabel("Answer");
	l4.setFont(new Font("Optima", Font.BOLD, 13));
	l4.setBounds(109, 192, 104, 21);
	contentPane.add(l4);

	JLabel l5 = new JLabel("Password");
	l5.setFont(new Font("Optima", Font.BOLD, 13));
	l5.setBounds(109, 224, 104, 21);
	contentPane.add(l5);

	t1 = new JTextField();
	t1.setFont(new Font("Optima", Font.BOLD, 13));
	...
	t2.setFont(new Font("Optima", Font.BOLD, 13));
	...
	t3.setFont(new Font("Optima", Font.BOLD, 12));
	...
	t4 = new JTextField();
	t4.setFont(new Font("Optima", Font.BOLD, 13));
	...
	t5.setFont(new Font("Optima", Font.BOLD, 13));
	...
	b1.setFont(new Font("Optima", Font.BOLD, 12));
	...
	b2.setFont(new Font("Optima", Font.BOLD, 12));
	...
	b3.setFont(new Font("Optima", Font.BOLD, 13));
