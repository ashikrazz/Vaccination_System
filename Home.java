...
public class Home extends JFrame implements ActionListener {
    ...
    public Home(){
        ...
        JMenuItem vaccinedetails = new JMenuItem("Vaccine Details");
        vaccinedetails.addActionListener(this);
        vaccinedetails.setBackground(new Color(211,211,211));
        vaccinedetails.setForeground(Color.DARK_GRAY);
        mnRecord.add(vaccinedetails);

        JMenuItem userdetails = new JMenuItem("User Details");
        userdetails.setBackground(new Color(211,211,211));
        userdetails.setForeground(Color.DARK_GRAY);
        userdetails.addActionListener(this);
        mnRecord.add(userdetails);

        menuBar.add(mnRecord);
        menuBar.add(mnHelp);
        menuBar.add(mnExit);

        JLabel l1 = new JLabel("Vaccine Management System");
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icons/vaccine.png"));
        ...
        ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icons/adduser.png"));
        Image i8 = i7.getImage().getScaledInstance(200,160,Image.SCALE_DEFAULT);
        ImageIcon i9 = new ImageIcon(i8);
        l4 = new JLabel(i9);
        l4.setBounds(530,140,225,152);
        contentPane.add(l4);

        b1 = new JButton("Add Vaccine");
        ...
        ImageIcon i13  = new ImageIcon(ClassLoader.getSystemResource("icons/take.png"));
        Image i14 = i13.getImage().getScaledInstance(210, 150,Image.SCALE_DEFAULT);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        }else if(msg.equals("Vaccine Details")){
            setVisible(false);
